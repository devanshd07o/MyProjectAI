...
FILLER_WORDS = [
    ...
    "jara", "zara", "thoda", "thodi",
    "ek baar", "bas", "sirf",

    # wake / attention
    "inferna", "hey", "hello", "are", "arey", "oye",
    "sun", "suno", "listen",

    # casual speech
    "bhai", "yaar", "bro", "buddy", "dude",
    "acha", "accha", "theek hai",
    "haan", "han", "haan ji",

    # glue words
    "mujhe", "mere", "mere ko", "mere liye",
    "tum", "aap",
    "ek kaam", "ek kaam karo",

    # hesitation
    "umm", "uh", "hmm", "matlab", "yaani",

    # unnecessary endings
    "na", "please na", "zara na"
]
...
async def listen():
    ...
    with sr.Microphone() as source:
        ...
        print("\n🎙️ Inferna is listening (silent mode)...")
        playsound("listen_beep.mp3")
        try:
            audio = recognizer.listen(
                source,
                timeout=12,
                phrase_time_limit=23
            )
